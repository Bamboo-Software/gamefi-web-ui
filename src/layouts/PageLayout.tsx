...
const PageLayout = () => {
  ...
  const navbars: INavbar[] = [
    {
      title: (
        <div className="">
          Lottery <span className="text-[#F3BE8E]">JuniperFOX</span> Game
        </div>
      ),
      path: ROOT,
      icon: logo,
  ...
  return (
    ...
    >
      <div
        className={`h-auto hidden md:block ${isCollapsed ? "w-20" : "w-64"} transition-all duration-300 flex-shrink-0`}
      >
      ...
      <div className="flex flex-col w-full h-screen  overflow-x-hidden">
        <div
          id="mobile-sidebar"
          className={`fixed md:hidden top-0 left-0 h-full z-50 transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col w-full h-screen overflow-x-hidden">
          <div className="sticky top-0 z-30 py-2 flex flex-row items-center justify-between rounded-lg px-2">
            <div className="flex flex-row items-center">
              ...
              >
                {isCollapsed ? (
                  ...
                  <TbLayoutSidebarLeftCollapse className="text-gray-50 size-5" />
                )}
              </Button>
              ...
              <div className="hidden md:flex flex-row items-center gap-4 lg:gap-8 ml-2 lg:ml-5">
                <div className="hidden md:flex flex-row items-center gap-4 lg:gap-8 ml-2 lg:ml-5">
                  <Link to={webLinks} className="text-gray-50! font-semibold text-sm whitespace-nowrap">
                    About Us
                  </Link>
                  <Link to={webLinks} className="text-gray-50! font-semibold text-sm whitespace-nowrap">
                    Introduction
                  ...
                  <Dropdown
                    ...
                    triggers={
                      <div className="flex items-center">
                        <span className="text-gray-50 font-semibold text-sm transition-colors whitespace-nowrap">
                          Follow Us
                        </span>
            ...
            <div className="text-gray-50 flex justify-center items-center gap-4">
