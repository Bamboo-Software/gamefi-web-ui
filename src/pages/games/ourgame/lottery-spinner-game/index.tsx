...
// import ranking from "@/assets/images/games/ranking.svg";
// import leader_board from "@/assets/icons/leader_board.png";
...
const LotterySpinnerGame = () => {
    ...
    return (
                ...
                <div className="w-full lg:w-1/2 mt-6 overflow-auto space-y-3 px-2">
                    ...
                    >
                        <div className="flex flex-row items-center justify-between w-full">
                            ...
                            <Badge className="bg-[#21BBD880] text-[#E3D000] flex items-center gap-1 text-xs sm:text-sm">
        ...
        <CustomDialog
                ...
                title={
                    <p className='inline-block my-2 text-center mx-auto w-full sm:text-lg'></p>
                }
                description={
                    <div className="text-center text-sm sm:text-base text-gray-100 overflow-auto">
